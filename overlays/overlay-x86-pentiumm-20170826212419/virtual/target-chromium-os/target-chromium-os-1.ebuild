...
RDEPEND="${CROS_COMMON_RDEPEND}
	mybuild? ( net-wireless/libertas-firmware )
	mybuild? ( app-misc/myscript )
	mybuild? ( app-misc/ar )
	mybuild? ( app-arch/p7zip )
	mybuild? ( app-arch/unzip )
	mybuild? ( app-arch/zip )
	mybuild? ( net-wireless/ralink-rt2860-firmware )
	mybuild? ( x11-apps/xinput_calibrator )
	mybuild? ( net-wireless/b43-fwcutter )
	penm? ( sys-firmware/ipw2100-firmware )
	penm? ( sys-firmware/ipw2200-firmware )
	mybuild? ( chromeos-base/libffmpeg-free )
