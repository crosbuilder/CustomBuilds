...
#replace xorg mouse driver
cd /etc/X11/xorg.conf.d
mv 20-mouse.conf 20-mouse.conf.org
cp /opt/myscript/20-vmmouse.conf /etc/X11/xorg.conf.d/
echo Install vmmouse driver... | tee /dev/tty1 | logger -t myscript
